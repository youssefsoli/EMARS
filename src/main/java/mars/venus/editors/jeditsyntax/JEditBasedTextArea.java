 ...
 * <p>
 * Provides those methods required by the MARSTextEditingArea interface that are not defined by JEditTextArea.  This
...
public class JEditBasedTextArea extends JEditTextArea implements MARSTextEditingArea, CaretListener
{
    ...
    /**
     * Same as setSelectedText but named for compatibility with JTextComponent method replaceSelection. DPS, 14 Apr
     * 2010
     *
