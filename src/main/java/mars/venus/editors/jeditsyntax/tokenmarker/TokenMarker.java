  ...
  * that can be mapped to a color for painting that token.<p>
  * <p>
  * For performance reasons, the linked list of tokens is reused after each line is tokenized. Therefore, the return
 ...
 public abstract class TokenMarker
 {
     ...
     /**
      * Creates a new <code>TokenMarker</code>. This DOES NOT create a lineInfo array; an initial call to
      * <code>insertLines()</code> does that.
      */
      ...
      * to add syntax tokens to the token list. Then, it should return the initial token type for the next line.<p>
      * <p>
      ...
      * token marker is required to pass all lines in the document to the
      * <code>markTokens()</code> method (in turn).<p>
      * <p>
      * The default implementation returns true; it should be overridden to return false on simpler token markers for
      * increased speed.
      */
      ...
      * action is taken if the array is large enough already.<p>
      * <p>
      * It should be unnecessary to call this under normal circumstances; <code>insertLine()</code> should take care of
